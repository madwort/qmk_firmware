 ...
 */
    [_NAVSYM] = LAYOUT(
      KC_GRV , KC_EXLM, KC_AT  ,  KC_UP ,  KC_DLR, SS_HELLO,                                     KC_PGUP,   KC_7 ,  KC_8 , KC_9,    KC_0, KC_DEL,
 ...
 */
    [_NAVSYMR] = LAYOUT(
      _______,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                                     KC_PGUP,   KC_NO, KC_UP  ,   KC_NO,   KC_NO, _______,
      _______,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                                     KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT,   KC_NO, _______,
 ...
 */
  ...
  /*
   * Mouse Layer: Mousekeys, mouse click
   *
   * ,-------------------------------------------.                              ,-------------------------------------------.
   * |        |      |MOUSEK| Mo Up|      |      |                              |      |      |      |      |      |        |
   * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
   ...
   * |  NAV   |      |      |      |      |      |      |      |  |      |      |      |      |      |      |      |        |
   * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
   *                        |      |ADJUST|      |      |Mouse2|  |Mouse1|      |NavSym|      |      |
   *                        |      |      |      |      |      |  |      |      |      |      |      |
   *                        `----------------------------------'  `----------------------------------'
   */
  [_MOUSEKE] = LAYOUT(
    _______, _______, MOUSEKE, KC_MS_U , _______, _______,                                    _______, _______, _______, _______, _______, _______,
    _______, _______, KC_MS_L, KC_MS_D , KC_MS_R, _______,                                    _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______ , _______, _______,_______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                               _______, ADJUST, _______,_______, KC_MS_BTN2, KC_MS_BTN1, _______, NAVSYM, _______, _______
  ),
